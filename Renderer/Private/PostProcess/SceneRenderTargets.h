...
#define GET_STENCIL_MOBILE_SM_MASK(Value) uint8((Value & 0x7) << 1)
	...
	#define PREVENT_RENDERTARGET_SIZE_THRASHING (PLATFORM_DESKTOP || PLATFORM_PS4 || PLATFORM_ANDROID || PLATFORM_OPENHARMONY || PLATFORM_IOS || PLATFORM_SWITCH || PLATFORM_UNIX)
#endif
