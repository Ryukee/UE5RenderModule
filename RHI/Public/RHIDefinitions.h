...
#define DDPI_NUM_STATIC_SHADER_PLATFORMS 16
	...
	SP_OPENGL_ES3_1_OPENHARMONY,
	SP_VULKAN_ES3_1_OPENHARMONY,
	SP_VULKAN_SM5_OPENHARMONY,
...
class RHI_API FGenericDataDrivenShaderPlatformInfo
{
	...
	uint32 bIsOpenHarmonyOpenGLES : 1;
...
public:
	...
	static FORCEINLINE_DEBUGGABLE const bool GetIsOpenHarmonyOpenGLES(const FStaticShaderPlatform Platform)
	{
		return Infos[Platform].bIsOpenHarmonyOpenGLES;
	}
...
inline bool IsMobilePlatform(const EShaderPlatform Platform)
{
	return 
		...
		|| Platform == SP_VULKAN_ES3_1_OPENHARMONY || Platform == SP_VULKAN_SM5_OPENHARMONY
		|| Platform == SP_VULKAN_ES3_1_ANDROID || Platform == SP_VULKAN_PCES3_1 || Platform == SP_VULKAN_ES3_1_LUMIN
		|| Platform == SP_SWITCH_FORWARD || Platform == SP_OPENGL_ES3_1_OPENHARMONY
...
inline bool IsOpenGLPlatform(const FStaticShaderPlatform Platform)
{
	return Platform == SP_OPENGL_PCES3_1
		|| Platform == SP_OPENGL_ES3_1_ANDROID || Platform == SP_OPENGL_ES3_1_OPENHARMONY
...
inline bool IsVulkanSM5Platform(const FStaticShaderPlatform Platform)
{
	return Platform == SP_VULKAN_SM5 || Platform == SP_VULKAN_SM5_LUMIN || Platform == SP_VULKAN_SM5_ANDROID
		|| Platform == SP_VULKAN_SM5_OPENHARMONY
...
{
	return Platform == SP_VULKAN_SM5_ANDROID || Platform == SP_VULKAN_SM5_OPENHARMONY;
}
...
inline bool IsOpenHarmonyOpenGLESPlatform(const FStaticShaderPlatform Platform)
{
	return Platform == SP_OPENGL_ES3_1_OPENHARMONY || FDataDrivenShaderPlatformInfo::GetIsOpenHarmonyOpenGLES(Platform);
}
...
inline bool IsVulkanMobilePlatform(const FStaticShaderPlatform Platform)
{
	return Platform == SP_VULKAN_PCES3_1 || Platform == SP_VULKAN_ES3_1_ANDROID || Platform == SP_VULKAN_ES3_1_LUMIN
		|| Platform == SP_VULKAN_ES3_1_OPENHARMONY
...
inline FStaticFeatureLevel GetMaxSupportedFeatureLevel(const FStaticShaderPlatform InShaderPlatform)
{
	...
	case SP_VULKAN_SM5_OPENHARMONY:
	...
	case SP_OPENGL_ES3_1_OPENHARMONY:
	case SP_VULKAN_ES3_1_OPENHARMONY:
...
inline bool RHISupportsSeparateMSAAAndResolveTextures(const FStaticShaderPlatform Platform)
{
	...
	return !IsMetalMobilePlatform(Platform) && !IsAndroidOpenGLESPlatform(Platform) && !IsOpenHarmonyOpenGLESPlatform(Platform);
}
...
inline bool RHIHasTiledGPU(const FStaticShaderPlatform Platform)
{
	...
	return Platform == SP_METAL || Platform == SP_METAL_TVOS
		...
		|| Platform == SP_OPENGL_ES3_1_OPENHARMONY
		|| Platform == SP_VULKAN_ES3_1_OPENHARMONY
...
{
	return Platform == EShaderPlatform::SP_OPENGL_ES3_1_ANDROID || Platform == EShaderPlatform::SP_OPENGL_ES3_1_OPENHARMONY || IsVulkanMobilePlatform(Platform)
