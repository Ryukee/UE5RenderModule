...
static const FText& GetFriendlyShaderPlatformName(const EShaderPlatform InShaderPlatform)
{
	...
	{
		static const FText Description = NSLOCTEXT("FriendlyShaderPlatformNames", "OpenHarmony_ES31_loc", "OpenHarmony ES31");
		return Description;
	}
	break;
	...
	{
		static const FText Description = NSLOCTEXT("FriendlyShaderPlatformNames", "OpenHarmony_Vulkan_ES31_loc", "OpenHarmony Vulkan ES31");
		return Description;
	}
	break;
	...
	{
		static const FText Description = NSLOCTEXT("FriendlyShaderPlatformNames", "OpenHarmony_Vulkan_SM5_loc", "OpenHarmony Vulkan SM5");
		return Description;
	}
	break;
