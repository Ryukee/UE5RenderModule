...
static FName NAME_GLSL_ES3_1_OPENHARMONY(TEXT("GLSL_ES3_1_OPENHARMONY"));
...
static FName NAME_VULKAN_ES3_1_OPENHARMONY(TEXT("SF_VULKAN_ES31_OPENHARMONY"));
static FName NAME_VULKAN_ES3_1_OPENHARMONY_NOUB(TEXT("SF_VULKAN_ES31_OPENHARMONY_NOUB"));
static FName NAME_VULKAN_SM5_OPENHARMONY(TEXT("SF_VULKAN_SM5_OPENHARMONY"));
static FName NAME_VULKAN_SM5_OPENHARMONY_NOUB(TEXT("SF_VULKAN_SM5_OPENHARMONY_NOUB"));
...
static FName ShaderPlatformToShaderFormatName(EShaderPlatform Platform)
{
	...
	case SP_OPENGL_ES3_1_OPENHARMONY:
		return NAME_GLSL_ES3_1_OPENHARMONY;
	...
	case SP_VULKAN_ES3_1_OPENHARMONY:
		return NAME_VULKAN_ES3_1_OPENHARMONY_NOUB;
	case SP_VULKAN_SM5_OPENHARMONY:
	{
		static auto* CVar = IConsoleManager::Get().FindTConsoleVariableDataInt(TEXT("r.Vulkan.UseRealUBs"));
		return (CVar && CVar->GetValueOnAnyThread() == 0) ? NAME_VULKAN_SM5_OPENHARMONY_NOUB : NAME_VULKAN_SM5_OPENHARMONY;
	}
...
static EShaderPlatform ShaderFormatNameToShaderPlatform(FName ShaderFormat)
{
	...
	if (ShaderFormat == NAME_GLSL_ES3_1_OPENHARMONY)		return SP_OPENGL_ES3_1_OPENHARMONY;
	if (ShaderFormat == NAME_VULKAN_ES3_1_OPENHARMONY)		return SP_VULKAN_ES3_1_OPENHARMONY;
	if (ShaderFormat == NAME_VULKAN_ES3_1_OPENHARMONY_NOUB)	return SP_VULKAN_ES3_1_OPENHARMONY;
	if (ShaderFormat == NAME_VULKAN_SM5_OPENHARMONY)		return SP_VULKAN_SM5_OPENHARMONY;
	if (ShaderFormat == NAME_VULKAN_SM5_OPENHARMONY_NOUB)	return SP_VULKAN_SM5_OPENHARMONY;
