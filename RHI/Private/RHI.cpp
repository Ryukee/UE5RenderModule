...
static FName NAME_PLATFORM_OPENHARMONY(TEXT("OpenHarmony"));
...
FName ShaderPlatformToPlatformName(EShaderPlatform Platform)
{
	...
	case SP_VULKAN_SM5_OPENHARMONY:
		return NAME_PLATFORM_OPENHARMONY;
...
FString LexToString(EShaderPlatform Platform)
{
    ...
    case SP_OPENGL_ES3_1_OPENHARMONY: return TEXT("OPENGL_ES3_1_OPENHARMONY");
	...
	case SP_VULKAN_ES3_1_OPENHARMONY: return TEXT("VULKAN_ES3_1_OPENHARMONY");
	case SP_VULKAN_SM5_OPENHARMONY: return TEXT("VULKAN_SM5_OPENHARMONY");
...
void FGenericDataDrivenShaderPlatformInfo::ParseDataDrivenShaderInfo(const FConfigSection& Section, FGenericDataDrivenShaderPlatformInfo& Info)
{
	...
	Info.bIsOpenHarmonyOpenGLES = GetSectionBool(Section, "bIsOpenHarmonyOpenGLES");
